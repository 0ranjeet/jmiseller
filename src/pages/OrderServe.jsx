 ...
 const serviceType = 'order';
  ...
  useEffect(() => {
    const fetchOrderCounts = async () => {
      ...
      try {
        setLoading(true);
        const q = query(collection(db, 'orderList'), where('sellerId', '==', sellerId),where ('serviceType','==','order'));
