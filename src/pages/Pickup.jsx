...
import { SecureDispatchModal } from '../components/SecureDispatchModal';
...
const AssignedOrders = () => {
    ...
    const fetchAssignedOrders = async () => {
      ...
      try {
        ...
        const q = query(
          ...
          where('orderStatus', 'in', ['Assigned', 'PickedUp', 'InWarehouse','Dispatched', 'Delivered'])
        );
  ...
  return (
    <>
      ...
      <SecureDispatchModal
        modal={secureDispatchModal}
        onClose={() => setSecureDispatchModal(null)}
        sellerId={sellerId}
...
export default React.memo(AssignedOrders);